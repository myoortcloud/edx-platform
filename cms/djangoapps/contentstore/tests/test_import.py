...
class ContentStoreImportTest(ModuleStoreTestCase):
    ...
    def _verify_split_test_import(self, target_course_name, source_course_name, split_test_name, vertical_mapping):
        module_store = modulestore()
        ...
        for key, value in vertical_mapping.iteritems():
            vertical_mapping[key] = target_course_id.make_usage_key('vertical', value)

        self.assertEqual(vertical_mapping, split_test_module.group_id_to_child)
